...
namespace PacktPub.VSPackageSample
{
    ...
    [ProvideEditorExtension(typeof(EditorFactory), ".vspackagesample", 50, 
              ProjectGuid = "{A2FE74E1-B743-11d0-AE1A-00A0C90FFFC3}", 
              TemplateDir = "Templates", 
              NameResourceID = 105,
              DefaultName = "VSPackageSample")]
    [ProvideKeyBindingTable(GuidList.guidVSPackageSampleEditorFactoryString, 102)]
    ...
    [Guid(GuidList.guidVSPackageSamplePkgString)]
    public sealed class VSPackageSamplePackage : Package
    {
        /// <summary>
