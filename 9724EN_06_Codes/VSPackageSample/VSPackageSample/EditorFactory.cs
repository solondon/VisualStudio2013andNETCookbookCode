...
namespace PacktPub.VSPackageSample
{
    ...
    /// </summary>
    [Guid(GuidList.guidVSPackageSampleEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private VSPackageSamplePackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(VSPackageSamplePackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidVSPackageSampleEditorFactory;
            pgrfCDW = 0;
