...
using PacktPub.VSPackageSample;

namespace VSPackageSample_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VSPackageSamplePackage() as IVsPackage;
            ...
            BaseMock registerEditor = VSPackageSample_UnitTests.EditorTests.RegisterEditorsServiceMock.GetRegisterEditorsInstance();
            ...
            CommandID menuCommandID = new CommandID(PacktPub.VSPackageSample.GuidList.guidVSPackageSampleCmdSet, (int)PacktPub.VSPackageSample.PkgCmdIDList.cmdidMyCommand);
