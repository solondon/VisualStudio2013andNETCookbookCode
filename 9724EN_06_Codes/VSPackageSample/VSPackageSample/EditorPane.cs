...
namespace PacktPub.VSPackageSample
{
    ...
    //     - An empty vspackagesample file in the same directory as NewFileItems.vsdir. In
    //       our case we chose MyExtFile.vspackagesample. Note this file name appears in Editor.vsdir
    ...
    //             be named as MyExtFile1.vspackagesample, MyExtFile2.vspackagesample... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    MyExtFile.vspackagesample|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - MyExtFile.vspackagesample - our empty vspackagesample file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".vspackagesample";
        ...
        #region Fields
        private VSPackageSamplePackage myPackage;
        ...
        public EditorPane(VSPackageSamplePackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the vspackagesample document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(VSPackageSamplePackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidVSPackageSampleCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidVSPackageSampleCmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidVSPackageSampleEditorFactory;
            return VSConstants.S_OK;
        }
